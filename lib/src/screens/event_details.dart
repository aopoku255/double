...
class _EventDetailsState extends State<EventDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime startTime =
        DateFormat("HH:mm:ss").parse(event.eventStartTime);
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(event.eventImages),
                                    fit: BoxFit.cover),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              MainText(
                                text:
                                    "${formattedStartTime} - ${formattedEndTime} GMT",
                                fontSize: 12,
                              ),
                            ],
                          )
                                                ...
                                                builder: (context, setState) {
                                                  return AlertDialog(
                                                    ...
                                                    content: Container(
                                                      ...
                                                      child: TextField(
                                                        maxLines:
                                                            5, // You can also use `null` for unlimited
                                                        decoration:
                                                            const InputDecoration(
                                                          hintText:
                                                              "Type your question here...",
                                                          border: InputBorder
                                                              .none, // Use container's border only
                                                        ),
                                                      ),
                                                    ),
                                                    actions: [
                                  ...
                                  : Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          MainText(
                                              text:
                                                  "Below is your ticket to the event"),
                                          SizedBox(
                                            height: 10,
                                          ),
